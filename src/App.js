...
import ReservationEdit from './components/Reservation'
    ...
    return (
      <Router>
        <div className="App">
          ...
          <Route path='/reservation/:id/edit' render={routerProps => <ReservationEdit {...routerProps} reservation={this.props.reservation}/>}/>
